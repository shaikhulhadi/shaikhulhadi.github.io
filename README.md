...
### Documentation
To get the official template of this website, visit [MrGreen-JekyllTheme](https://github.com/MrGreensWorkshop/MrGreen-JekyllTheme) on github.
...
As it says in the [MIT license](https://github.com/MrGreensWorkshop/MrGreen-JekyllTheme/blob/main/LICENSE.txt), one could use this theme anywhere as long as you include the license and copyright notice.

`Copyright (c) 2022 Mr. Green's Workshop https://www.MrGreensWorkshop.com`

Please add link to mr green's page or leave the "Pwrd by Mr. Green" link in the footer to give credit for his work.

Thank you!

### Other Licenses

Mr. Green Jekyll Theme incorporates libraries written below. Without these libraries
